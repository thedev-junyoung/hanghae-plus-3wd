...
class CouponTest {
    ...
    void isExpired_shouldReturnTrue() {
        // given
    ...
    void isExpired_shouldReturnFalse() {
    ...
    void validateUsable_shouldThrowExpired() {
    ...
    void validateUsable_shouldThrowExhausted() {
    ...
    void decreaseQuantity_shouldSucceed() {
    ...
    void percentageCoupon_shouldApplyCorrectDiscount() {
    ...
    void fixedCoupon_shouldNotGoBelowZero() {
