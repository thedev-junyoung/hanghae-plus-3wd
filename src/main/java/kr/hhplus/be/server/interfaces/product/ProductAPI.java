...
import kr.hhplus.be.server.regacy.domain.product.dto.response.PopularProductResponse;
import kr.hhplus.be.server.regacy.domain.product.dto.response.ProductDetailResponse;
import kr.hhplus.be.server.regacy.domain.product.dto.response.ProductListResponse;
